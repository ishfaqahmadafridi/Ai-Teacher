...
export function SocialAuth({
  ...
  return (
    <div className={showDivider ? 'mt-8' : 'mt-0'}>
      {/* Optional Divider */}
      {showDivider && (
        <div className="flex items-center gap-4 mb-6">
          <div className="h-px flex-grow bg-white/10" />
          <span className="text-[12px] font-medium leading-4 uppercase tracking-[0.1em] text-[#c6c6cc]/60 font-['Inter',sans-serif]">
            {dividerText}
          </span>
          <div className="h-px flex-grow bg-white/10" />
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Button
          ...
          className="flex items-center justify-center gap-2.5 py-3 rounded-xl text-[#e5e2e3] text-[14px] font-semibold
                     ...
                     transition-all duration-200 h-auto shadow-none cursor-pointer font-['Inter',sans-serif]"
        >
