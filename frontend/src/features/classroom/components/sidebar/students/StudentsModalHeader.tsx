  ...
  return (
    <div className={`flex items-center justify-between p-5 md:p-6 border-b border-white/10 bg-[#111318]/50 ${className}`}>
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-[#1b2559] border border-[#b8c3ff]/30 flex items-center justify-center text-[#b8c3ff] shadow-lg shadow-[#1b2559]/50">
          <Users className="w-5 h-5" aria-hidden="true" />
        </div>
        <div>
          <h3 className="font-['Hanken_Grotesk',sans-serif] text-base md:text-lg font-bold text-[#e2e2e8]">
            {title}
          </h3>
