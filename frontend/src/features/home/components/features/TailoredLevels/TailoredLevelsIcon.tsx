...
import type { TailoredLevelsIconProps } from '../../../types';

export const TailoredLevelsIcon = memo(function TailoredLevelsIcon({ name }: TailoredLevelsIconProps) {
  switch (name) {
    case 'book':
      return (
...
TailoredLevelsIcon.displayName = 'TailoredLevelsIcon';
