...
export const DEFAULT_LIVE_CLASSES: LiveClassItem[] = [
  ...
  },
  {
    ...
    completedLessons: 8,
    totalLessons: 20,
    timeRemaining: 'Starts at 02:00 PM',
  },
  {
    id: 'class-3',
    ...
    timeFormatted: 'Tomorrow, 09:00 AM',
    isLive: false,
    attendanceCount: 56,
    bgGradient: 'from-[#712ae2]/20 to-blue-600/20',
    progressPercent: 75,
    completedLessons: 15,
    totalLessons: 20,
    timeRemaining: 'Tomorrow 09:00 AM',
  },
  {
    id: 'class-4',
    title: 'Organic Reactions & Synthesis',
    subject: 'Chemistry 101',
    instructorName: 'Prof. Robert Lang',
    instructorAvatar:
      'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
    timeFormatted: 'Tomorrow, 01:00 PM',
    isLive: false,
    attendanceCount: 31,
    bgGradient: 'from-[#10B981]/20 to-teal-600/20',
    progressPercent: 50,
    completedLessons: 10,
    totalLessons: 20,
    timeRemaining: 'Tomorrow 01:00 PM',
  },
];
