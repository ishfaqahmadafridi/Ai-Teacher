...
export const ProjectSettingsModal = memo(function ProjectSettingsModal(
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto animate-in fade-in duration-200 font-['Hanken_Grotesk',sans-serif]">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-2xl bg-[#0F172A] border border-[#1E293B] rounded-3xl shadow-2xl z-10 my-8 overflow-hidden">
        {/* Header */}
        ...
        {/* Form Body */}
        <form onSubmit={handleSave} className="p-6 sm:p-8 max-h-[58vh] overflow-y-auto">
          {activeTab === 'ai_mentor' && (
