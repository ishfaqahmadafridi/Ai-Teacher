...
export function OnboardingHeader() {
  return (
    <header className="fixed top-0 w-full z-50 bg-[#0a0f1d]/60 backdrop-blur-[40px] saturate-[180%] border-b border-white/10 shadow-[0px_0px_20px_rgba(0,67,235,0.15)]">
      <div className="flex justify-between items-center px-4 md:px-10 py-3 max-w-[1280px] mx-auto">
          ...
          <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[#0043eb] to-[#ddb7ff] p-[2px] shadow-[0_0_15px_rgba(0,67,235,0.5)]">
            <div className="w-full h-full bg-[#0a0f1d] rounded-[10px] flex items-center justify-center">
              <Image
                ...
                style={{ filter: 'drop-shadow(0 0 8px rgba(79, 195, 247, 0.8))' }}
                priority
              />
            </div>
          </div>
        ...
        <div className="hidden md:flex gap-8 text-sm font-medium">
          <Link href="/home" className="text-[#c6c6cc] hover:text-white transition-colors no-underline">
            Curriculum
          </Link>
          <Link href="/home" className="text-[#c6c6cc] hover:text-white transition-colors no-underline">
            Mentors
