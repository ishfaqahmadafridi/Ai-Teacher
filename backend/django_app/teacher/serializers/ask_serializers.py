"""
teacher/serializers/ask_serializers.py

Request and response serializers for the Ask/Teacher endpoint.
"""
...
class AskRequestSerializer(serializers.Serializer):
    """
    Serializer for student request payload.
    """
...
class AskResponseSerializer(serializers.Serializer):
    """
    Serializer for structured professor response payload.
    """
    question = serializers.CharField()
